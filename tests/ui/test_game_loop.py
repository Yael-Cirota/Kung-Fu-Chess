...
class TestRunGameLoop:
    def test_feeds_drained_clicks_into_the_controller(self):
        ...
        run_game_loop(
            canvas, controller, FakeAnimator(), FakeRenderer(), CELL_SIZE_PX,
            clock=FakeClock([0.0, 0.0]),
        )

        assert controller.clicks == [(10, 20), (30, 40)]
    ...
    def test_advances_engine_by_elapsed_wall_time(self):
        ...
        assert controller.advances == [40, 60]
        assert controller.clock_ms == 100
    ...
    def test_clamps_a_large_wall_gap_to_the_max_engine_step(self):
        ...
        assert controller.advances == [MAX_ENGINE_STEP_MS]
    ...
    def test_stops_when_show_reports_quit(self):
        ...
        run_game_loop(
            canvas, controller, FakeAnimator(), renderer, CELL_SIZE_PX,
    ...
    def test_stops_when_the_game_is_over(self):
        ...
        controller = FakeController(game_over_after_frames=2)
        renderer = FakeRenderer()
    ...
    def test_routes_the_two_clocks_to_build_visual_states(self, monkeypatch):
        ...
        def spy_build(game_controller, animator, engine_ms, render_ms, cell_size_px):
        ...
        assert recorded["engine_ms"] == controller.clock_ms == 40  # engine clock, read after advance
